define(['application/NoteOrganizerModule', 
    ...
    function (NoteOrganizerModule, TabService, NoteService, DialogService) {
        NoteOrganizerModule.controller("TabsetController", function ($state, $filter, $scope, notes, tabs, TabService, NoteService, DialogService) {
